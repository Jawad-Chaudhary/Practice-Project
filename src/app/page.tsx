  ...
  return (
    <main className=" scroll-smooth focus:scroll-auto">
      ...
      <div className="flex flex-col items-center w-800px">
        <h2 className="text-4xl font-extrabold ">Business owners trust Pulse.</h2>
        <p className="mt-6 text-[18px] text-gray-400">Below are real quotes from business owners.</p>
      </div>

      <section className="flex flex-col items-center justify-center w-[450px]">
      ...
      <div className="flex flex-col items-center mt-14">
        <h2 className="font-extrabold text-lg">“Pulse shows me how to track cash flow the right way.”</h2>
        <p className="text-[18px] text-gray-600 mt-2 leading-7">Stop stumbling your way through spreadsheets not knowing what you don't know. Pulse shows you a simple, easy to understand chart that answers the questions you have about your cash flow.</p>
      </div>
      ...
      <div className="flex flex-col items-center mt-14">
        <h2 className="font-extrabold text-lg">“I like the simplicity.”</h2>
        <p className="text-[18px] text-gray-600 mt-2 leading-7">Pulse is meant to do one thing really well—cash flow management. No other product on the market is as focused on putting you in control of how cash moves in and out of your business.</p>
      </div>
      ...
      <div className="flex flex-col items-center mt-14">
        <h2 className="font-extrabold text-lg">“I can connect it to my accounting software.”</h2>
        <p className="text-[18px] text-gray-600 mt-2 leading-7">With our direct connection to QuickBooks Online, keeping your cash flow projections and your actual performance in sync is a breeze.</p>
      </div>
      </section>
      </section>

      <section className="mt-32 border-t-gray-200 border-t-[3px] h-[700px] 
      flex justify-evenly items-center">
        <div className="w-[600px]">
          <h3 className="text-4xl leading-[45px] font-extrabold">Make smarter business decisions with Pulse.</h3>
          <p className="text-[18px] text-gray-600 mt-2 leading-7">Do you know if you can hire another employee or take some money out of the company? Should you take on that new project or should turn it down? With Pulse, you immediately see how business decisions will impact your cash in the future, which in turn gives you the confidence you need to know if the decision is right.</p>
        </div>

        <div className="w-[400px] bg-white border-solid border-gray-200 border-2
        flex flex-col items-center p-10 animate-pulse">
          <Image src="/images/avatar.png" alt="avatar-profile" width={80} height={80}/>
          <div className="mt-5 text-2xl text-center text-[#00ad6a]">“Pulse makes my business smarter. We make better decisions because we can see further. You could say it has lowered our stress level by removing the fear of not knowing.”</div>
          <div className="text-[12px] tracking-widest mt-5 font-extrabold text-gray-500">Carl Smith, Bureau of Digital</div>
          <div className="mt-4 text-[13px] font-extrabold underline text-[#00ad6a]">Read Customer Story &#8594;</div>
        </div>
      </section>

      <section className="h-[700px] w-full relative ">
        <Image src="/images/guy-smile.jpg" alt="Customer-Review" fill objectFit="cover" 
        className="relative"/>
        <div className="absolute bg-green-600 bg-opacity-[0.6] z-10 top-0 right-0 bottom-0 left-0
        flex items-center">
          <div className="text-white ml-32 w-[530px]">
            <h2 className="text-5xl font-extrabold leading-[50px] animate-pulse">Pulse is specifically designed for small businesses.</h2>
            <p className="mt-6 text-lg w-[430px]">Our customers include creative and technology agencies, service providers, restaurants, manufacturers, retail shops, contractors, freelancers, and more.</p>
            <button className="text-black text-lg font-extrabold mt-7 bg-white ml-[12px] px-7 py-4 transition-all duration-[0.25s]
            hover:px-10 hover:ml-[0px] hover:text-xl active:opacity-45">Sign Up For a Free 30-Day Trial</button>
          </div>
        </div>
      </section>
      ...
      <section className="h-[800px] flex flex-col items-center justify-center">
        ...
        <div className="w-[1100px] grid grid-cols-3 gap-y-20 gap-x-5 mt-12">
          <div className="flex flex-col items-center  w-[315px]">
            <Image src="/images/cash-flow.png" alt="cash-flow" width={55} height={55} />
            <h4 className="mt-8 font-extrabold text-lg">Multiple Cash Flow Views</h4>
          ...
          <div className="flex flex-col items-center  w-[315px]">
            ...
            <h4 className="mt-8 font-extrabold text-lg">Visual Reports</h4>
          ...
          <div className="flex flex-col items-center  w-[315px]">
            ...
            <h4 className="mt-8 font-extrabold text-lg">Invite Your Team</h4>
          ...
          <div className="flex flex-col items-center  w-[314px]">
            <Image src="/images/connect.png" alt="connect" width={55} height={55} />
            <h4 className="mt-8 font-extrabold text-lg">Connects to Quickbooks Online</h4>
      ...
      flex justify-evenly items-center">
        <div className="w-[520px]">
          <h3 className="text-4xl leading-[45px] font-extrabold">Pulse is the easy, online way to manage and project your cash flow.</h3>
      ...
      <section className="h-[150px] bg-gradient-to-r from-[#00ad6a] to-[#1fe374] flex justify-center items-center">
        <div className="text-white text-4xl font-extrabold underline underline-offset-1
        transition-all duration-[0.25s] hover:text-black animate-bounce"><a href="https://signup.pulseapp.com/plus">Sign Up for a Free 30-Day Trial &#8594;</a></div>
      </section>
    </main>
  )
}