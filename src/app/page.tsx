...
export default function Home() {
  ...
  return (
    <main className=" scroll-smooth focus:scroll-auto">
      ...
      <section data-aos="fade-up" data-aos-duration="3000" className="md:h-[150px] h-auto bg-gradient-to-r from-[#00ad6a] to-[#1fe374] flex justify-center items-center text-center">
